...
export function RiskBadge({ level, explanation, size = 'default' }: RiskBadgeProps) {
  ...
  const badge = (
    <span className={`inline-flex items-center gap-1 rounded-full px-2 py-0.5 font-medium ${textSize} ${config.className}`}>
